...
/// <summary>
/// Summary description for rpt_comision_arrastre_planilla_detalle.
/// </summary>
public class rpt_comision_arrastre_planilla_detalle : DataDynamics.ActiveReports.ActiveReport3
{
    public void CargarDatos(bool bolivianos, decimal tc, DateTime arrastre_inicio, DateTime arrastre_fin, DateTime inicial_inicio, DateTime inicial_fin, string Negocio)
    {
        ...
        textBox2.Text = "PLANILLA DE COMISIONES " + mes + " " + arrastre_inicio.Year.ToString() + " (DETALLE)";
        if (bolivianos == true) textBox7.Text = "(EXPRESADO EN BOLIVIANOS ; T/C: " + tc.ToString("F2") + ")";
        else textBox7.Text = "(EXPRESADO EN DÓLARES)";

        textBox46.Text = "Ventas nuevas ($us)";
        if (bolivianos == true)
        {
            textBox14.Text = "Comisión C.Inicial (Bs)";
            textBox15.Text = "Comisión Arrastres (Bs)";
            textBox16.Text = "Bonos de movilidad (Bs)";
            textBox17.Text = "Bonos de producción (Bs)";
        ...
        else
        {
            ...
            textBox16.Text = "Bonos de movilidad ($us)";
            textBox17.Text = "Bonos de producción ($us)";
        ...
        textBox52.Text = Negocio;
    }

    private void rpt_comision_arrastre_planilla_detalle_ReportStart(object sender, EventArgs e)
    {
        //MARGENES
    ...
    public void CargarEstilos()
    {
        ...
        textBox26.ClassName = "estiloSubtotalEnun";
        ...
        textBox30.ClassName = "estiloSubtotal";
        textBox31.ClassName = "estiloSubtotal";
	...
	public rpt_comision_arrastre_planilla_detalle()
	{
		//
	...
	{
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.rpt_comision_arrastre_planilla_detalle));
        ...
        this.textBox12.Left = 0.8125F;
        this.textBox12.Name = "textBox12";
        this.textBox12.Style = "";
        this.textBox12.Text = "Nº contrato";
        ...
        this.textBox13.Left = 1.5625F;
        this.textBox13.Name = "textBox13";
        this.textBox13.Style = "";
        this.textBox13.Text = "Sector";
        ...
        this.textBox16.Left = 5.4375F;
        this.textBox16.Name = "textBox16";
        this.textBox16.Style = "";
        this.textBox16.Text = "Bonos de movilidad";
        ...
        this.textBox17.Text = "Bonos de producción";
        ...
        this.textBox20.DataField = "sector";
        ...
        this.textBox21.DataField = "com_inicial";
        this.textBox21.Height = 0.1875F;
        this.textBox21.Left = 3.6875F;
        ...
        this.textBox22.DataField = "com_arrastre";
        ...
        this.textBox23.DataField = "bono_mov";
        ...
        this.textBox24.DataField = "bono_prod";
        this.textBox24.Height = 0.1875F;
        this.textBox24.Left = 6.3125F;
        ...
        this.textBox25.DataField = "total_ganado";
        ...
        this.textBox47.DataField = "venta_nueva";
        this.textBox47.Height = 0.1875F;
        this.textBox47.Left = 2.8125F;
        ...
        this.reportHeader1.Controls.AddRange(new DataDynamics.ActiveReports.ARControl[] {
            ...
            this.textBox51,
            this.textBox52});
        this.reportHeader1.Height = 1.375F;
        ...
        this.textBox51.Text = "Negocio:";
        this.textBox51.Top = 1.1875F;
        this.textBox51.Width = 2.9375F;
        // 
        // textBox52
        // 
        ...
        this.textBox33.Text = "SubTotal GRUPO:";
        ...
        this.textBox11.DataField = "promotor_nombre";
        ...
        // 
        // rpt_comision_arrastre_planilla_detalle
        // 
        ...
        this.ReportStart += new System.EventHandler(this.rpt_comision_arrastre_planilla_detalle_ReportStart);
