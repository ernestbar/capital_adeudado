...
/// <summary>
/// Summary description for rpt_marketing_reversiones_resumen.
/// </summary>
public class rpt_marketing_reversiones_resumen : DataDynamics.ActiveReports.ActiveReport3
{
    ...
    public void CargarDatos(bool Director, string Fecha_reversion, string Fecha_cuota_inicial, string Num_pagos, string Porcentaje, string Monto, string Motivos_reversion)
    {
        ...
        if (Director == false) { textBox3.Text = "Reporte de reversiones para descuentos a Promotores (Resumen)"; }
        else { textBox3.Text = "Reporte de reversiones para descuentos a Directores (Resumen)"; }

        textBox5.Text = Fecha_reversion;
        textBox9.Text = Fecha_cuota_inicial;
        textBox32.Text = Num_pagos;
        textBox21.Text = Porcentaje;
        textBox27.Text = Monto;
        textBox33.Text = Motivos_reversion;
    }
    private void rpt_marketing_reversiones_resumen_ReportStart(object sender, EventArgs e)
    {
        //MARGENES
	...
	public rpt_marketing_reversiones_resumen()
	{
		InitializeComponent();
	}
	...
	{
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.rpt_marketing_reversiones_resumen));
        ...
        this.textBox16.Text = "Saldo Revertido ($us)";
        ...
        this.textBox10.DataField = "comision_pagada";
        ...
        this.textBox12.DataField = "capital_pagado";
        ...
        this.textBox18.DataField = "capital_adeuda";
        ...
        this.textBox20.Left = 1.25F;
        this.textBox20.Name = "textBox20";
        this.textBox20.Style = "";
        this.textBox20.Text = "% mínimo de capital cancelado para evitar el descuento:";
        this.textBox20.Top = 1.1875F;
        this.textBox20.Width = 4.0625F;
        // 
        // textBox21
        // 
        ...
        this.textBox23.Text = "Monto mínimo de capital cancelado para evitar el descuento:";
        this.textBox23.Top = 1.375F;
        this.textBox23.Width = 4.0625F;
        // 
        // textBox27
        // 
        ...
        this.textBox31.Left = 1.25F;
        this.textBox31.Name = "textBox31";
        this.textBox31.Style = "";
        this.textBox31.Text = "Motivos de reversión tomados en cuenta:";
        this.textBox31.Top = 1.5625F;
        this.textBox31.Width = 4.0625F;
        // 
        // textBox33
        // 
        ...
        this.textBox13.DataField = "capital_pagado";
        ...
        this.textBox19.DataField = "capital_adeuda";
        this.textBox19.Height = 0.1875F;
        this.textBox19.Left = 6.4375F;
        ...
        this.textBox17.DataField = "capital_adeuda";
        ...
        // 
        // rpt_marketing_reversiones_resumen
        // 
        this.MasterReport = false;
        this.PageSettings.PaperHeight = 11F;
        this.PageSettings.PaperWidth = 8.5F;
        this.PrintWidth = 8.562503F;
        ...
        this.ReportStart += new System.EventHandler(this.rpt_marketing_reversiones_resumen_ReportStart);
