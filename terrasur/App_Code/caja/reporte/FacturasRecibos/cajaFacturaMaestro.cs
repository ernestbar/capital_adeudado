...
/// <summary>
/// Summary description for cajaFacturaMaestro.
/// </summary>
/// 
namespace terrasur 
{
    public class cajaFacturaMaestro : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        private void cajaFacturaMaestro_ReportStart(object sender, EventArgs e)
        {
            this.PageSettings.DefaultPaperSize = false;
            this.PageSettings.DefaultPaperSource = false;
            this.Document.Printer.PrinterName = "";
            this.PageSettings.PaperKind = System.Drawing.Printing.PaperKind.Custom;
            this.Document.Printer.PaperSize = new System.Drawing.Printing.PaperSize("Factura", 850, 550);
        ...
        private void cajaFacturaMaestro_FetchData(object sender, DataDynamics.ActiveReports.ActiveReport3.FetchEventArgs eArgs)
        {
            string codigo_tp = transaccion.CodigoTipoPago(Convert.ToInt32(Fields["id_transaccion"].Value));
            int id_factura = 0;
            if (Convert.ToInt32(Fields["id_factura"].Value) > 0)
            {
                id_factura = Convert.ToInt32(Fields["id_factura"].Value);
            }
            else
            {
                id_factura = factura.IdPorTransaccion(Convert.ToInt32(Fields["id_transaccion"].Value));
            }
            factura f = new factura(id_factura);
            //ENCABEZADO
            //string dir_imagen = HttpRuntime.AppDomainAppPath + "/Images/" + f.nit.ToString() + ".gif";
            ...
            textBox23.Text = f.encabezado_empresa;
            textBox24.Text = f.encabezado_actividad;


            sucursal sObj = new sucursal(sucursal.IdSucursalPorIdDocumento(id_factura, 0, 0), 0);
            if (sObj.num_sucursal == 0)
            {
                //Casa Matriz:
                textBox25.Text = "CASA MATRIZ";
                textBox26.Text = f.encabezado_direccion;
                textBox27.Text = f.encabezado_telefono;
                textBox28.Text = f.encabezado_lugar;
                //Sucursal:
                textBox16.Text = "";
                textBox29.Text = "";
                textBox30.Text = "";
            ...
            {
                //Sucursal:
                textBox25.Text = "SUCURSAL Nº " + sObj.num_sucursal.ToString();
                textBox26.Text = sObj.direccion;
                textBox27.Text = sObj.telefono;
                textBox28.Text = sObj.lugar;
                //Casa Matriz:
                textBox16.Text = "CASA MATRIZ";
                textBox29.Text = f.encabezado_direccion;
                textBox30.Text = f.encabezado_telefono;
                textBox31.Text = f.encabezado_lugar;
            }

            textBox2.Text = f.nit.ToString();
            textBox4.Text = f.num_factura.ToString();
            textBox10.Text = f.num_autorizacion.ToString();  
            textBox8.Text = f.cliente_nombre;
            textBox11.Text = f.cliente_nit.ToString();
            textBox13.Text = f.fecha.ToString("d");
            textBox15.Text = f.tipo_cambio.ToString(); 
            textBox19.Text = f.numero_control;
            textBox20.Text = f.fecha_limite.ToString("d");

            switch (codigo_tp)
            {
                case "ini":
                    PagoFacturaConcepto pfc = new PagoFacturaConcepto();
                    pfc.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value), id_factura);
                    subReport1.Report = pfc;
                    PagoInicialFacturaDetalle pid = new PagoInicialFacturaDetalle();
                ...
                case "ade":
                case "pla":
                    PagoFacturaConcepto pfc1 = new PagoFacturaConcepto();
                    pfc1.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value), id_factura);
                    subReport1.Report = pfc1;
                    PagoFacturaDetalle pfd = new PagoFacturaDetalle();
                    pfd.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value));
                    subReport2.Report = pfd;
                    break;
                case "cap":
                    PagoFacturaConcepto pfc2 = new PagoFacturaConcepto();
                    pfc2.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value), id_factura);
                    subReport1.Report = pfc2;
                    PagoInicialFacturaDetalle pid1 = new PagoInicialFacturaDetalle();
                    pid1.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value));
                    subReport2.Report = pid1;
                    break;
                case "OtroServicio":
                    PagoFacturaConcepto pfc3 = new PagoFacturaConcepto();
                    pfc3.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value), id_factura);
                    subReport1.Report = pfc3;
                    OtroServicioFacturaDetalle osfd = new OtroServicioFacturaDetalle();
                    osfd.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value));
                    subReport2.Report = osfd;
                    break;
                case "OtroServicioNoCliente":
                    if (terrasur.terraplus.tp_pago.VerificarTransaccionTerraPlus(Convert.ToInt32(Fields["id_transaccion"].Value)) == true)
                    {
                        TerraPlusFacturaConcepto tpfc = new TerraPlusFacturaConcepto();
                        tpfc.LlenarDatos(id_factura);
                        subReport1.Report = tpfc;

                        TerraPlusFacturaDetalle tpfd = new TerraPlusFacturaDetalle();
                        tpfd.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value));
                        subReport2.Report = tpfd;
                    }
                    else
                    {
                        OtroServNoClienteFacturaConcepto osfc = new OtroServNoClienteFacturaConcepto();
                        osfc.LlenarDatos(id_factura);
                        subReport1.Report = osfc;
                        OtroServNoClienteFacturaDetalle osnfd = new OtroServNoClienteFacturaDetalle();
                        osnfd.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value));
                        subReport2.Report = osnfd;
                    }
                    break;
                case "PagoMora":
                    PagoFacturaConcepto pfc4 = new PagoFacturaConcepto();
                    pfc4.LlenarDatos(Convert.ToInt32(Fields["id_transaccion"].Value),id_factura);
                    subReport1.Report = pfc4;
                    PagoMoraFacturaDetalle pmd = new PagoMoraFacturaDetalle();
        ...
        {
            //ENCABEZADO
            textBox23.ClassName = "facturaEncabezadoEmpresa";
            textBox24.ClassName = "facturaEncabezadoActividad";
            textBox25.ClassName = "facturaEncabezadoCasaMatriz";
            textBox26.ClassName = "facturaEncabezadoDireccion";
            textBox27.ClassName = "facturaEncabezadoTelefono";
            textBox28.ClassName = "facturaEncabezadoLugar";

            textBox16.ClassName = "facturaEncabezadoCasaMatriz";
            textBox29.ClassName = "facturaEncabezadoDireccion";
            textBox30.ClassName = "facturaEncabezadoTelefono";
            textBox31.ClassName = "facturaEncabezadoLugar";

            //
            textBox1.ClassName = "facturaTituloEnun";
            textBox3.ClassName = "facturaTituloEnun";
            textBox6.ClassName = "facturaTituloEnun";

            textBox2.ClassName = "facturaTituloDato";
            textBox4.ClassName = "facturaTituloDato";
            textBox10.ClassName = "facturaTituloDato";

            textBox5.ClassName = "facturaNombre";
           
            textBox7.ClassName = "facturaConceptoEnun";
            textBox9.ClassName = "facturaConceptoEnun";
            textBox12.ClassName = "facturaConceptoEnun";
            textBox14.ClassName = "facturaConceptoEnun";
            //textBox16.ClassName = "facturaConceptoEnun";

            textBox8.ClassName = "facturaConceptoDato";
            textBox11.ClassName = "facturaConceptoDato";
            textBox13.ClassName = "facturaConceptoDato";
            textBox15.ClassName = "facturaConceptoDato";

            textBox17.ClassName = "facturaPieEnun";
            textBox18.ClassName = "facturaPieEnun";

            textBox19.ClassName = "facturaPieDato";
            textBox20.ClassName = "facturaPieDato";

            textBox21.ClassName = "facturaNota1";
            textBox22.ClassName = "facturaNota2";
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.cajaFacturaMaestro));
            ...
            this.textBox17.Left = 0.3125F;
            this.textBox17.Name = "textBox17";
            this.textBox17.Style = "";
            this.textBox17.Text = "Código de control:";
            this.textBox17.Top = 0.1875F;
            this.textBox17.Width = 1.5F;
            // 
            // textBox18
            // 
            ...
            this.textBox18.Left = 3.75F;
            this.textBox18.Name = "textBox18";
            this.textBox18.Style = "";
            this.textBox18.Text = "Fecha límite de emisión:";
            this.textBox18.Top = 0.1875F;
            this.textBox18.Width = 2.375F;
            // 
            // textBox19
            // 
            ...
            this.textBox22.Left = 6.375F;
            this.textBox22.Name = "textBox22";
            this.textBox22.Style = "";
            this.textBox22.Text = "Reimpresión";
            ...
            this.textBox21.Text = "La reproducción parcial o total y/o el uso no autorizado de esta Nota Fiscal, con" +
                "stituye un delito a ser sancionado conforme a ley.";
            this.textBox21.Top = 0F;
            this.textBox21.Width = 7.25F;
            // 
            // pageFooter
            // 
            ...
            this.groupHeader1.Height = 1.5625F;
            ...
            this.textBox5.Left = 2.75F;
            this.textBox5.Name = "textBox5";
            this.textBox5.Style = "";
            this.textBox5.Text = "F A C T U R A";
            ...
            this.textBox6.Style = "";
            this.textBox6.Text = "No. autorización:";
            ...
            this.textBox24.Top = 0.535F;
            this.textBox24.Width = 1.875F;
            // 
            // textBox25
            // 
            ...
            this.textBox25.Top = 0.63F;
            this.textBox25.Width = 1.875F;
            // 
            // textBox26
            // 
            ...
            this.textBox26.Height = 0.0625F;
            this.textBox26.Left = 0F;
            this.textBox26.Name = "textBox26";
            this.textBox26.Style = "";
            this.textBox26.Text = null;
            this.textBox26.Top = 0.73F;
            this.textBox26.Width = 1.875F;
            // 
            // textBox27
            // 
            ...
            this.textBox27.Height = 0.0625F;
            this.textBox27.Left = 0F;
            this.textBox27.Name = "textBox27";
            this.textBox27.Style = "";
            this.textBox27.Text = null;
            this.textBox27.Top = 0.83F;
            this.textBox27.Width = 1.875F;
            // 
            // textBox28
            // 
            ...
            this.textBox30.Height = 0.0625F;
            this.textBox30.Left = 0F;
            this.textBox30.Name = "textBox30";
            this.textBox30.Style = "";
            this.textBox30.Text = "textBox30";
            this.textBox30.Top = 1.24F;
            this.textBox30.Width = 1.875F;
            // 
            // textBox31
            // 
            ...
            this.textBox31.Height = 0.0625F;
            this.textBox31.Left = 0F;
            this.textBox31.Name = "textBox31";
            this.textBox31.Style = "";
            this.textBox31.Text = "textBox31";
            this.textBox31.Top = 1.34F;
            this.textBox31.Width = 1.875F;
            // 
            // textBox32
            // 
            ...
            this.FetchData += new DataDynamics.ActiveReports.ActiveReport3.FetchEventHandler(this.cajaFacturaMaestro_FetchData);
            this.ReportStart += new System.EventHandler(this.cajaFacturaMaestro_ReportStart);
