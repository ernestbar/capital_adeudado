...
/// <summary>
/// Summary description for PagoMoraFacturaDetalle.
/// </summary>
/// 
namespace terrasur
{
    public class PagoMoraFacturaDetalle : DataDynamics.ActiveReports.ActiveReport3
    {
        private DataDynamics.ActiveReports.Detail detail;

        public PagoMoraFacturaDetalle()
        {
            //
        ...
        private void PagoMoraFacturaDetalle_ReportStart(object sender, EventArgs e)
        {
            //ESTILOS
        ...
        public void LlenarDatos(int Id_transaccion)
        {
            ...
            pago_mora p = new pago_mora(pago_mora.IdPorTransaccion(Id_transaccion));
            transaccion tObj = new transaccion(Id_transaccion);

            decimal monto_bs;
            if (tObj.codigo_moneda == "$us")
            {
                monto_bs = p.monto_pagado * tObj.tipo_cambio;
                textBox1.Text = "Interés Penal ($us):";
                textBox2.Text = "$us:";
                textBox7.Text = p.monto_pagado.ToString("F2");
            }
            else
            {
                monto_bs = p.monto_pagado;
                textBox1.Text = "Interés Penal (Bs):";
                textBox2.Text = "";
                textBox7.Text = "";
            }
        ...
        {
            string resourceFileName = "PagoMoraFacturaDetalle.resx";
            System.Resources.ResourceManager resources = Resources.PagoMoraFacturaDetalle.ResourceManager;
            ...
            this.textBox1.Text = "Interés Penal ($us):";
            // 
            // textBox2
            // 
            ...
            // 
            // PagoMoraFacturaDetalle
            // 
            this.PageSettings.PaperHeight = 11F;
            this.PageSettings.PaperWidth = 8.5F;
            this.PrintWidth = 7.052083F;
            this.Sections.Add(this.detail);
            this.ReportStart += new System.EventHandler(this.PagoMoraFacturaDetalle_ReportStart);
