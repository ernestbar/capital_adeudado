...
/// <summary>
/// Summary description for PagoCapitalComprobanteDetalle.
/// </summary>
/// 
namespace terrasur
{
    public class PagoCapitalComprobanteDetalle : DataDynamics.ActiveReports.ActiveReport3
    {
        private DataDynamics.ActiveReports.Detail detail;

        public PagoCapitalComprobanteDetalle()
        {
            //
        ...
        private void PagoCapitalComprobanteDetalle_ReportStart(object sender, EventArgs e)
        {
            //ESTILOS
        ...
        public void LlenarDatos(int Id_transaccion)
        {
            ...
            pago p_actual = new pago(id_pago);
            int id_pago_anterior = pago.IdPagoAnterior(p_actual.id_pago, p_actual.id_contrato);
    
            string codigo_moneda = contrato.CodigoMoneda(p_actual.id_contrato);

            textBox4.Text = new pago(id_pago_anterior).saldo.ToString("F2") + " " + codigo_moneda;
            textBox5.Text = p_actual.monto_pago.ToString("F2") + " " + codigo_moneda;
            textBox6.Text = p_actual.saldo.ToString("F2") + " " + codigo_moneda;
        }
        public void CargarEstilos()
        {
            ...
            textBox4.ClassName = "comprobanteDetalleDato";
            textBox5.ClassName = "comprobanteDetalleDato";
        ...
        {
            string resourceFileName = "PagoCapitalComprobanteDetalle.resx";
            System.Resources.ResourceManager resources = Resources.PagoCapitalComprobanteDetalle.ResourceManager;
            ...
            this.textBox1.Size = new System.Drawing.SizeF(3.0625F, 0.1875F);
            this.textBox1.Text = "Saldo Anterior:";
            // 
            // textBox2
            // 
            ...
            this.textBox2.Size = new System.Drawing.SizeF(3.0625F, 0.1875F);
            this.textBox2.Text = "Pago directo a capital (amortización):";
            // 
            // textBox3
            // 
            ...
            this.textBox3.Size = new System.Drawing.SizeF(3.0625F, 0.1875F);
            this.textBox3.Text = "Nuevo saldo:";
            // 
            // textBox4
            // 
            ...
            // 
            // PagoCapitalComprobanteDetalle
            // 
            this.PageSettings.PaperHeight = 11F;
            this.PageSettings.PaperWidth = 8.5F;
            this.PrintWidth = 7.03125F;
            this.Sections.Add(this.detail);
            this.ReportStart += new System.EventHandler(this.PagoCapitalComprobanteDetalle_ReportStart);
