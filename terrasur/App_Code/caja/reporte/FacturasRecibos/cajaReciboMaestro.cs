    ...
    public class cajaReciboMaestro : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        private void cajaReciboMaestro_FetchData(object sender, DataDynamics.ActiveReports.ActiveReport3.FetchEventArgs eArgs)
        {
            ...
            if (es_terreno == false)
            {
                ...
                //Se oculta los mensajes de pie de página
                textBox35.Text = "";
                textBox45.Text = "";

                //Se oculta el número de recibo de cobrador
                textBox3.Text = "";
                textBox4.Text = "";
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox35.Text = "Comunicado: El traspaso y/o cambio de nombre del contrato tendrá un costo variabl" +
