...
/// <summary>
/// Summary description for PagoInicialFacturaDetalle.
/// </summary>
/// 
namespace terrasur
{
    public class PagoInicialFacturaDetalle : DataDynamics.ActiveReports.ActiveReport3
    {
        private DataDynamics.ActiveReports.Detail detail;

        public PagoInicialFacturaDetalle()
        {
            //
        ...
        private void PagoInicialFacturaDetalle_ReportStart(object sender, EventArgs e)
        {
            //ESTILOS
        ...
        public void LlenarDatos(int Id_transaccion)
        {
            ...
            {
                monto_bs = p.monto_pago * tObj.tipo_cambio;
                textBox1.Text = "Amortización ($us):";
                textBox2.Text = "$us:";
                textBox7.Text = p.monto_pago.ToString("F2");
            }
            else
            {
                monto_bs = p.monto_pago;
                textBox1.Text = "Amortización (Bs):";
                textBox2.Text = "";
                textBox7.Text = "";
            }
        ...
        {
            string resourceFileName = "PagoInicialFacturaDetalle.resx";
            System.Resources.ResourceManager resources = Resources.PagoInicialFacturaDetalle.ResourceManager;
            ...
            this.textBox1.Text = "Amortización ($us):";
            // 
            // textBox2
            // 
            ...
            // 
            // PagoInicialFacturaDetalle
            // 
            this.PageSettings.PaperHeight = 11F;
            this.PageSettings.PaperWidth = 8.5F;
            this.PrintWidth = 7.03125F;
            this.Sections.Add(this.detail);
            this.ReportStart += new System.EventHandler(this.PagoInicialFacturaDetalle_ReportStart);
