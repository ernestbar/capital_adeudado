...
/// <summary>
/// Summary description for cajaTransaccionReimpresionUnDoc.
/// </summary>
/// 
namespace terrasur 
{
    public class cajaTransaccionReimpresionUnDoc : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public cajaTransaccionReimpresionUnDoc()
        {
            //
        ...
        private void cajaTransaccionReimpresionUnDoc_ReportStart(object sender, EventArgs e)
        {
        ...
        public void CargarDatos(int Id_usuario, bool Reimpresion,string tipo_documento)
        {
            textBox1.Text = Id_usuario.ToString();
            if (Reimpresion == true) { textBox2.Text = "1"; } else { textBox2.Text = "0"; }
            textBox3.Text = tipo_documento;
        }

        private void cajaTransaccionReimpresionUnDoc_FetchData(object sender, DataDynamics.ActiveReports.ActiveReport3.FetchEventArgs eArgs)
        {
            ...
            string _Tipo_documento = textBox3.Text;

            //Para el primer espacio:
            if (_Tipo_documento == "Factura" &&  id_factura>0)
            {
                ...
                subReport1.Report = fObj;
            }
            else if (_Tipo_documento == "Recibo" && id_recibo>0)
            {
            ...
            else if (_Tipo_documento == "Comprobante" && id_comprobantedpr > 0)
            {
            ...
            {
                cajaTransaccionVacio1 transVacioObj = new cajaTransaccionVacio1();
                subReport1.Report = transVacioObj;
            }

            //Para el segundo espacio:
            cajaTransaccionVacio1 tVacioObj = new cajaTransaccionVacio1();
            subReport2.Report = tVacioObj;
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.cajaTransaccionReimpresionUnDoc));
            ...
            // 
            // cajaTransaccionReimpresionUnDoc
            // 
            ...
            this.FetchData += new DataDynamics.ActiveReports.ActiveReport3.FetchEventHandler(this.cajaTransaccionReimpresionUnDoc_FetchData);
            this.ReportStart += new System.EventHandler(this.cajaTransaccionReimpresionUnDoc_ReportStart);
