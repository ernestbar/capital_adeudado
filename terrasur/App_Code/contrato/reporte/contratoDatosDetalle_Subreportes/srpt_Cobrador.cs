...
/// <summary>
/// Summary description for srpt_Cobrador.
/// </summary>
public class srpt_Cobrador : DataDynamics.ActiveReports.ActiveReport3
{
    ...
    public void DatosCobrador(int Id_contrato)
    {
        terrasur.contrato c = new terrasur.contrato(Id_contrato);
        terrasur.cobrador cb = new terrasur.cobrador(c.id_cobrador_vigente);
        textBox3.Text = cb.paterno.ToString() + " " + cb.materno.ToString() + " " + cb.nombres.ToString();
    }
    private void srpt_Cobrador_ReportStart(object sender, EventArgs e)
    {
	...
	{
        string resourceFileName = "srpt_Cobrador.resx";
        System.Resources.ResourceManager resources = Resources.srpt_Cobrador.ResourceManager;
        ...
        this.textBox1.Text = "Datos del cobrador";
        // 
        // textBox2
        // 
        ...
        this.textBox3.Size = new System.Drawing.SizeF(3F, 0.1875F);
        ...
        this.ReportStart += new System.EventHandler(this.srpt_Cobrador_ReportStart);
