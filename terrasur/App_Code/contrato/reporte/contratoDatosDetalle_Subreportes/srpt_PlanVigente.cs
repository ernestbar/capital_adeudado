...
/// <summary>
/// Summary description for srpt_PlanVigente.
/// </summary>
public class srpt_PlanVigente : DataDynamics.ActiveReports.ActiveReport3
{
    ...
    public void DatosPlan(int Id_contrato)
    {
        ...
        if (c.id_planpago_vigente > 0)
        {
            ...
            textBox7.Text = pp.num_cuotas.ToString();
            textBox8.Text = pp.seguro.ToString("F2");
            textBox9.Text = pp.mantenimiento_sus.ToString("F2");
            textBox10.Text = pp.interes_corriente.ToString("F2");
            textBox11.Text = pp.interes_penal.ToString("F2");
            textBox13.Text = pp.cuota_base.ToString("F2");
            textBox15.Text = pp.fecha_inicio_plan.ToString("d");
        }
        else
        {
            textBox7.Text = c.num_cuotas.ToString();
            textBox8.Text = c.seguro.ToString("F2");
    ...
    private void srpt_PlanVigente_ReportStart(object sender, EventArgs e)
    {
	...
	{
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.srpt_PlanVigente));
        ...
        this.textBox1.Style = "";
        this.textBox1.Text = "Plan de pagos vigente";
        ...
        this.textBox5.Style = "";
        this.textBox5.Text = "Interés Corr.  (% anual)";
        ...
        this.textBox6.Left = 5.125F;
        this.textBox6.Name = "textBox6";
        this.textBox6.Style = "";
        this.textBox6.Text = "Interés Penal (% mensual)";
        ...
        this.ReportStart += new System.EventHandler(this.srpt_PlanVigente_ReportStart);
