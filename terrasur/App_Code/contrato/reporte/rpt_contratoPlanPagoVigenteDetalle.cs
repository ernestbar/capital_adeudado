...
/// <summary>
/// Summary description for rpt_contratoPlanPagoVigenteDetalle.
/// </summary>
public class rpt_contratoPlanPagoVigenteDetalle : DataDynamics.ActiveReports.ActiveReport3
{
	...
	public rpt_contratoPlanPagoVigenteDetalle()
	{
		//
    ...
    public void DatosPlanPagosVigenteDetalle(int Id_contrato, string Nombre_persona)
    {
        rpt_Encabezado encabezado = new rpt_Encabezado();
        encabezado.DatosContrato(Id_contrato, true);
        subReport1.Report = encabezado;
        textBox14.Text = "Fecha de emisión: " + DateTime.Now.ToString("F");
        textBox17.Text = "Usuario: " + Nombre_persona;
    ...
    private void rpt_contratoPlanPagoVigenteDetalle_ReportStart(object sender, EventArgs e)
    {
        //MARGENES
    ...
    {
        textBox14.ClassName = "estiloFecha";
        textBox17.ClassName = "estiloFecha";
	...
	{
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.rpt_contratoPlanPagoVigenteDetalle));
        ...
        this.textBox1.Style = "";
        this.textBox1.Text = "Plan de pagos vigente en detalle";
        ...
        this.textBox3.Left = 15.9375F;
        this.textBox3.Name = "textBox3";
        this.textBox3.Style = "";
        this.textBox3.Text = "Nota: Este plan de pagos es REFERENCIAL";
        ...
        this.groupFooter1.Controls.AddRange(new DataDynamics.ActiveReports.ARControl[] {
            ...
            this.textBox4,
            this.line1});
        this.groupFooter1.Height = 0.6666667F;
        ...
        this.textBox17.Left = 15.1875F;
        this.textBox17.Name = "textBox17";
        this.textBox17.Style = "";
        this.textBox17.Text = "textBox17";
        this.textBox17.Top = 0.1875F;
        this.textBox17.Width = 4.25F;
        // 
        // rpt_contratoPlanPagoVigenteDetalle
        // 
        this.MasterReport = false;
        this.PageSettings.PaperHeight = 11F;
        this.PageSettings.PaperWidth = 8.5F;
        this.PrintWidth = 19.47917F;
        ...
        this.ReportStart += new System.EventHandler(this.rpt_contratoPlanPagoVigenteDetalle_ReportStart);
