...
/// <summary>
/// Summary description for rpt_Encabezado.
/// </summary>
public class rpt_Encabezado : DataDynamics.ActiveReports.ActiveReport3
{
    ...
    public void DatosContrato(int Id_contrato, bool Vigente)
    {
        ...
        //textBox40.Text = c.estado_nombre + " " + terrasur.contrato.EstadoActualFecha(Id_contrato).ToShortDateString();
        string fecha_estado = terrasur.contrato.EstadoActualFecha(Id_contrato).ToShortDateString();
        if (c.estado_nombre == "Revertido" && fecha_estado == "31/12/2011") { textBox40.Text = c.estado_nombre; }
        else { textBox40.Text = c.estado_nombre + " " + fecha_estado; }

        textBox9.Text = cv.urbanizacion_nombre_corto.ToString();
        textBox10.Text = cv.manzano_codigo.ToString();
        textBox11.Text = cv.lote_codigo.ToString();
        textBox12.Text = cv.superficie_m2.ToString("F2");
        textBox13.Text = cv.precio_m2_sus.ToString("F2");
        //textBox12.Text = new terrasur.lote(cv.id_lote).superficie_m2.ToString("F2");
        //textBox13.Text = new terrasur.lote(cv.id_lote).precio_m2_sus.ToString("F2");
        terrasur.cliente cl = new terrasur.cliente(c.id_titular);
        textBox14.Text = cl.paterno.ToString() + ' ' + cl.materno.ToString() + ' ' + cl.nombres.ToString();
        textBox24.Text = c.precio.ToString("F2");

        //decimal descuento = (c.descuento_efectivo) + ((c.descuento_porcentaje / 100) * c.precio);
        //textBox25.Text = descuento.ToString("F");
        textBox38.Text = c.descuento_porcentaje.ToString("F2");
        textBox25.Text = c.descuento_efectivo.ToString("F2");
        textBox27.Text = c.cuota_inicial.ToString("F2");
        if ((c.id_planpago_vigente > 0) && (Vigente == true))
        {
            terrasur.plan_pago pp = new terrasur.plan_pago(c.id_planpago_vigente);
            textBox28.Text = pp.num_cuotas.ToString();
            textBox29.Text = pp.cuota_base.ToString("F2");
            textBox30.Text = pp.seguro.ToString("F3");
            textBox31.Text = pp.mantenimiento_sus.ToString("F2");
            textBox32.Text = pp.interes_corriente.ToString("F2");
            textBox42.Text = pp.fecha_inicio_plan.Day.ToString();
        }
        else
        {
            textBox28.Text = c.num_cuotas.ToString();
            textBox29.Text = c.cuota_base.ToString("F2");
            textBox30.Text = c.seguro.ToString("F3");
            textBox31.Text = c.mantenimiento_sus.ToString("F2");
            textBox32.Text = c.interes_corriente.ToString("F2");
            textBox42.Text = c.fecha_inicio_plan.Day.ToString();
        }
        if (c.id_promotor_vigente > 0)
        {
            terrasur.usuario pr = new terrasur.usuario(c.id_promotor_vigente);
            textBox34.Text = pr.paterno.ToString() + ' ' + pr.materno.ToString() + ' ' + pr.nombres.ToString();
        }
        else
        {
            textBox34.Text = "Sin asignar";
        }
        if (c.id_cobrador_vigente > 0)
        {
            terrasur.usuario cb = new terrasur.usuario(c.id_cobrador_vigente);
            textBox36.Text = cb.paterno.ToString() + ' ' + cb.materno.ToString() + ' ' + cb.nombres.ToString();
        }
        else
        {
            textBox36.Text = "Sin asignar";
        }
        textBox44.Text = terrasur.cliente_contrato.ListaClientesAdicionales_String(Id_contrato);

        decimal PagadoGestor = terrasur.contrato.PagadoGestor(Id_contrato);
        if (PagadoGestor > 0)
        {
            textBox45.Visible = true;
            textBox46.Visible = true;
            textBox46.Text = PagadoGestor.ToString("F2");
        }
        else
        {
        ...
        textBox15.Text = "Precio Total (" + c.codigo_moneda + ")";
        textBox16.Text = "Desc. (" + c.codigo_moneda + ")";
        textBox17.Text = "Precio Final (" + c.codigo_moneda + ")";
        textBox18.Text = "Cuota Inicial (" + c.codigo_moneda + ")";
        textBox20.Text = "Cuota Mensual (" + c.codigo_moneda + ")";
        textBox22.Text = "Mantenim. (" + c.codigo_moneda + "/mes)";
        textBox48.Text = new terrasur.moneda(c.id_moneda).nombre;

        int num_seguro = new terrasur.seguro_provida(Id_contrato).numero;
        if (num_seguro > 0) { textBox50.Text = num_seguro.ToString(); } else { textBox50.Text = "---"; }

        // Req. Capital Adeudado
        terrasur.capital_adeudado ca = new terrasur.capital_adeudado(Id_contrato);
        textBox53.Text = "Precio Financiado: (" + c.codigo_moneda + "):";
        textBox54.Text = c.precio_final.ToString("F2");
        textBox51.Text = "Capital Adeudado: (" + c.codigo_moneda + "):";
        textBox52.Text = ca.monto.ToString("F2");
        textBox26.Text = (c.precio_final + ca.monto).ToString("F2");
        //

    }
    private void rpt_Encabezado_ReportStart(object sender, EventArgs e)
    {
    ...
    public void CargarEstilos()
    {
        ...
        textBox17.ClassName = "estiloEncabEnun";
        ...
        textBox54.ClassName = "estiloEncabDato";
	...
	private void InitializeComponent()
	{
        ...
        this.textBox5.Left = 5.375F;
        this.textBox5.Name = "textBox5";
        this.textBox5.Style = "";
        this.textBox5.Text = "Superf.(m2)";
        ...
        this.textBox6.Height = 0.0625F;
        this.textBox6.Left = 3.3125F;
        this.textBox6.Name = "textBox6";
        this.textBox6.Style = "";
        this.textBox6.Text = "Precio ($/m2)";
        this.textBox6.Top = 1.3125F;
        this.textBox6.Visible = false;
        this.textBox6.Width = 0.375F;
        // 
        // textBox7
        // 
        ...
        this.textBox14.Width = 5.395833F;
        // 
        // textBox15
        // 
        ...
        this.textBox15.Height = 0.0625F;
        this.textBox15.Left = 1.0625F;
        this.textBox15.Name = "textBox15";
        this.textBox15.Style = "";
        this.textBox15.Text = "Precio Total ($)";
        this.textBox15.Top = 1.3125F;
        this.textBox15.Visible = false;
        this.textBox15.Width = 0.375F;
        // 
        // textBox16
        // 
        ...
        this.textBox16.Left = 2.5625F;
        this.textBox16.Name = "textBox16";
        this.textBox16.Style = "";
        this.textBox16.Text = "Desc. ($)";
        this.textBox16.Top = 1.3125F;
        this.textBox16.Visible = false;
        this.textBox16.Width = 0.375F;
        // 
        // textBox17
        // 
        ...
        this.textBox17.Text = "Precio Final ($)";
        this.textBox17.Top = 0.4375F;
        ...
        this.textBox18.Text = "Cuota Inicial ($)";
        this.textBox18.Top = 0.4375F;
        this.textBox18.Width = 1.1875F;
        // 
        // textBox19
        // 
        ...
        this.textBox19.Left = 5.854167F;
        this.textBox19.Name = "textBox19";
        this.textBox19.Style = "";
        this.textBox19.Text = "Nro. cuotas";
        this.textBox19.Top = 0.4375F;
        ...
        this.textBox20.Left = 6.708333F;
        this.textBox20.Name = "textBox20";
        this.textBox20.Style = "";
        this.textBox20.Text = "Cuota Mensual ($)";
        this.textBox20.Top = 0.4375F;
        this.textBox20.Width = 1.375F;
        // 
        // textBox21
        // 
        ...
        this.textBox21.Text = "Seg. (%/mes)";
        this.textBox21.Top = 0.4375F;
        ...
        this.textBox22.Left = 9.104167F;
        this.textBox22.Name = "textBox22";
        this.textBox22.Style = "";
        this.textBox22.Text = "Manten.($/mes)";
        this.textBox22.Top = 0.4375F;
        this.textBox22.Width = 1.4375F;
        // 
        // textBox23
        // 
        ...
        this.textBox23.Left = 10.58333F;
        this.textBox23.Name = "textBox23";
        this.textBox23.Style = "";
        this.textBox23.Text = "Interés (%/año)";
        this.textBox23.Top = 0.4375F;
        ...
        this.textBox28.Left = 5.854167F;
        this.textBox28.Name = "textBox28";
        this.textBox28.Style = "";
        this.textBox28.Text = null;
        this.textBox28.Top = 0.625F;
        ...
        this.textBox29.Left = 6.708333F;
        this.textBox29.Name = "textBox29";
        this.textBox29.Style = "";
        this.textBox29.Text = null;
        this.textBox29.Top = 0.625F;
        this.textBox29.Width = 1.375F;
        // 
        // textBox30
        // 
        ...
        this.textBox35.Left = 3.875F;
        this.textBox35.Name = "textBox35";
        this.textBox35.Style = "";
        this.textBox35.Text = "Cobrador:";
        ...
        this.textBox36.Left = 4.75F;
        this.textBox36.Name = "textBox36";
        this.textBox36.Style = "";
        this.textBox36.Text = null;
        this.textBox36.Top = 0.875F;
        ...
        this.textBox37.Height = 0.0625F;
        this.textBox37.Left = 1.8125F;
        this.textBox37.Name = "textBox37";
        this.textBox37.Style = "";
        this.textBox37.Text = "Desc. (%)";
        this.textBox37.Top = 1.3125F;
        ...
        this.textBox38.Height = 0.0625F;
        this.textBox38.Left = 2.1875F;
        this.textBox38.Name = "textBox38";
        this.textBox38.Style = "";
        this.textBox38.Text = "textBox38";
        this.textBox38.Top = 1.3125F;
        ...
        this.textBox41.Left = 10.08333F;
        this.textBox41.Name = "textBox41";
        this.textBox41.Style = "";
        this.textBox41.Text = "Día de pago:";
        this.textBox41.Top = 0.875F;
        ...
        this.textBox42.Left = 11.08333F;
        this.textBox42.Name = "textBox42";
        this.textBox42.Style = "";
        this.textBox42.Text = "textBox42";
        this.textBox42.Top = 0.875F;
        ...
        this.textBox43.Text = "Titulares adicionales:";
        this.textBox43.Top = 1.125F;
        this.textBox43.Width = 1.5F;
        // 
        // textBox44
        // 
        ...
        this.textBox44.Left = 1.625F;
        this.textBox44.Name = "textBox44";
        this.textBox44.Style = "";
        this.textBox44.Text = "textBox44";
        this.textBox44.Top = 1.125F;
        this.textBox44.Width = 6.0625F;
        // 
        // textBox45
        // 
        ...
        this.textBox45.Left = 7.770833F;
        this.textBox45.Name = "textBox45";
        this.textBox45.Style = "";
        this.textBox45.Text = "Pagado (Gestor):";
        ...
        this.textBox47.Left = 1.0625F;
        this.textBox47.Name = "textBox47";
        this.textBox47.Style = "";
        this.textBox47.Text = "Moneda";
        ...
        this.textBox49.Left = 9.833333F;
        this.textBox49.Name = "textBox49";
        this.textBox49.Style = "";
        this.textBox49.Text = "Nº Form. Seguro:";
        this.textBox49.Top = 1.125F;
        ...
        this.textBox50.Left = 11.08333F;
        this.textBox50.Name = "textBox50";
        this.textBox50.Style = "";
        this.textBox50.Text = "textBox50";
        this.textBox50.Top = 1.125F;
        ...
        this.textBox51.Left = 2.958333F;
        this.textBox51.Name = "textBox51";
        this.textBox51.Style = "";
        this.textBox51.Text = "Capital Adeudado ($)";
        this.textBox51.Top = 0.4375F;
        this.textBox51.Width = 1.625F;
        // 
        // textBox52
        // 
        ...
        this.textBox52.Left = 2.958333F;
        this.textBox52.Name = "textBox52";
        this.textBox52.Style = "";
        this.textBox52.Text = null;
        this.textBox52.Top = 0.625F;
        this.textBox52.Width = 1.625F;
        // 
        // textBox53
        // 
        ...
        this.textBox53.Left = 1.291667F;
        this.textBox53.Name = "textBox53";
        this.textBox53.Style = "";
        this.textBox53.Text = "Precio Financiado ($)";
        this.textBox53.Top = 0.4375F;
        this.textBox53.Width = 1.625F;
        // 
        // textBox54
        // 
        ...
        this.ReportStart += new System.EventHandler(this.rpt_Encabezado_ReportStart);
