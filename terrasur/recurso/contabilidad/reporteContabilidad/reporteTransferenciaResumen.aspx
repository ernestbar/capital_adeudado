<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte contable de transferencia (Resumen)" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteTransferenciaResumen") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_transferenciaResumen()
        reporte.DataSource = contabilidadReporte.Transferencia(cp_desde.SelectedDate, cp_hasta.SelectedDate, general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte contable de transferencia (Resumen)</td>
    </tr>
    <tr>
