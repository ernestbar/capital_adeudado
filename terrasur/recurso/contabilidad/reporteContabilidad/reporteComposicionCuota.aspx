<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de Composición de Cuota" %>
<%@ Register Src="~/recurso/userControl/recursoMaster.ascx" TagName="recursoMaster" TagPrefix="uc1" %>
<%@ Register Src="~/recurso/userControl/reporte.ascx" TagName="reporte" TagPrefix="uc2" %>
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteComposicionCuota") Then
    ...
    Protected Sub btn_mostrar_reporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_mostrar_reporte.Click
        ...
        If rbl_resumen_detalle.SelectedValue = "resumen" Then
            Dim reporte As New rpt_composicion_cuota
            reporte.DataSource = contabilidadReporte.ComposicionCuota(cp_inicio.SelectedDate, cp_fin.SelectedDate, general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
        ...
        Else
            Dim reporte As New rpt_composicion_cuota_detalle
            reporte.DataSource = contabilidadReporte.ComposicionCuotaDetalle(cp_inicio.SelectedDate, cp_fin.SelectedDate, general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
            reporte.CargarDatos(cp_inicio.SelectedDate, cp_fin.SelectedDate, general.StringNegocios(False, cbl_negocio.Items), rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
            Reporte1.WebView.Report = reporte
        End If
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_r" Runat="Server">
    <uc1:recursoMaster ID="RecursoMaster1" runat="server" recurso="reporteContabilidad" reporte="reporteComposicionCuota" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_c" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    </ajaxToolkit:ToolkitScriptManager>
    <table class="priTable">
        <tr><td class="priTdTitle">Reporte de Composición de Cuota</td></tr>
        <tr>
                            ...
                            <td class="formEntTdForm">
                                <table class="formTable" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="formTdDato">
                                            <asp:RadioButtonList ID="rbl_resumen_detalle" runat="server" RepeatDirection="Horizontal" CellPadding="0" CellSpacing="0">
                                                <asp:ListItem Text="Resumen por sector" Value="resumen" Selected="True"></asp:ListItem>
        ...
        <tr>
            <td>
                <uc2:reporte ID="Reporte1" runat="server" NombreReporte="reporteComposicionCuota" />
            </td>
        </tr>
    </table>
</asp:Content>