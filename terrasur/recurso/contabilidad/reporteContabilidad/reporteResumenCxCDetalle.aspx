<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Resumen de cuentas por cobrar (Detalle)" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteResumenCxCDetalle") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_resumen_cxc_detalle()
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Resumen de cuentas por cobrar (Detalle)</td>
    </tr>
    <tr>
