<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte contable de inventario (Resumen)" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteInventarioResumen") Then
    ...
    Public Sub cargarReporte()
        Dim reporte As New rpt_inventarioResumen()
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte contable de inventario (Resumen)</td>
    </tr>
    <tr>
