<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte contable de transferencia (Detalle)" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteTransferenciaDetalle") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_transferenciaDetalle()
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte contable de transferencia (Detalle)</td>
    </tr>
    <tr>
