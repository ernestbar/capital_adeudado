<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de Otros Servicios (Detalle)" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteOtrosServiciosDetalle") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_otrosServiciosDetalle()
        reporte.DataSource = contabilidadReporte.ReporteOtrosServicios(Int32.Parse(ddl_cajero.SelectedValue), Int32.Parse(ddl_servicio.SelectedValue), cp_desde.SelectedDate, cp_hasta.SelectedDate, general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
        reporte.Encabezado(cp_desde.SelectedDate, cp_hasta.SelectedDate, Int32.Parse(ddl_cajero.SelectedValue), general.StringNegocios(False, cbl_negocio.Items), rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
    ...
    Protected Sub ddl_servicio_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_servicio.DataBound
        ddl_servicio.Items.Insert(0, New ListItem("Todos", "0"))
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte de Otros Servicios (Detalle)</td>
    </tr>
    <tr>
                ...
                <tr>
                    <td class="tdFiltro">
                        <table class="formTable" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="formTdEnun">
                                    <asp:Label ID="lbl_servicio" runat="server" Text="Servicio:"></asp:Label></td>
                               <td class="formTdDato">
                                   <asp:DropDownList ID="ddl_servicio" runat="server" AutoPostBack="false" DataSourceID="ods_servicio_lista"
                                       DataTextField="nombre" DataValueField="id_servicio">
                                   </asp:DropDownList>
                                   <%--[id_usuario],[nombre]--%>
                                   <asp:ObjectDataSource ID="ods_servicio_lista" runat="server" TypeName="terrasur.servicio"
