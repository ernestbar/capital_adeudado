<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de Ventas y Cobranzas" %>
<%@ Register Src="~/recurso/userControl/recursoMaster.ascx" TagName="recursoMaster" TagPrefix="uc1" %>
<%@ Register Src="~/recurso/userControl/reporte.ascx" TagName="reporte" TagPrefix="uc2" %>
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteVentaCobranza") Then
    ...
    Protected Sub btn_mostrar_reporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_mostrar_reporte.Click
        ...
        If rbl_tipo.SelectedValue = "detalle" Then
            Dim reporte As New rpt_venta_cobranza
            reporte.DataSource = contabilidadReporte.VentasCobranzas_LocalizacionUrbanizacion(cp_inicio.SelectedDate, cp_fin.SelectedDate, Integer.Parse(rbl_traspaso.SelectedValue), general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
            reporte.CargarDatos(cp_inicio.SelectedDate, cp_fin.SelectedDate, rbl_traspaso.SelectedItem.Text.ToUpper, general.StringNegocios(False, cbl_negocio.Items), rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
            Reporte1.WebView.Report = reporte
        ElseIf rbl_tipo.SelectedValue = "resumen_mes" Then
            Dim tabla As Data.DataTable = contabilidadReporte.VentasCobranzas_ResumenMes(cp_inicio.SelectedDate, cp_fin.SelectedDate, Integer.Parse(rbl_traspaso.SelectedValue), general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
            Dim defView As Data.DataView = tabla.DefaultView
            defView.Sort = "negocio,pago_fecha"

            Dim reporte As New rpt_venta_cobranza_mes
            reporte.DataSource = defView
            reporte.Encabezado(cp_inicio.SelectedDate, cp_fin.SelectedDate, rbl_traspaso.SelectedItem.Text.ToUpper, general.StringNegocios(False, cbl_negocio.Items), rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
            Reporte1.WebView.Report = reporte
        End If
    End Sub
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_r" Runat="Server">
    <uc1:recursoMaster ID="RecursoMaster1" runat="server" recurso="reporteContabilidad" reporte="reporteVentaCobranza" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_c" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    </ajaxToolkit:ToolkitScriptManager>
    <table class="priTable">
        <tr><td class="priTdTitle">Reporte de Ventas y Cobranzas</td></tr>
        <tr>
                        ...
                        <tr>
                            <td class="formEntTdForm">
                                <table class="formTable" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="formTdEnun">Fecha de venta (Cuota Inicial):</td>
                                        <td class="formTdDato">
                                    ...
                                    <tr>
                                        ...
                                        <td class="formTdDato">
                                            <asp:RadioButtonList ID="rbl_traspaso" runat="server" CellPadding="0" CellSpacing="0" RepeatDirection="Horizontal">
                                                <asp:ListItem Text="Todos" Value="-1" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Traspaso" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="Normal (No traspaso)" Value="0"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="formTdEnun">Datos del reporte:</td>
                                        <td class="formTdDato">
                                            <asp:RadioButtonList ID="rbl_tipo" runat="server" CellPadding="0" CellSpacing="0" RepeatDirection="Horizontal">
                                                ...
                                                <asp:ListItem Text="Resumen por mes" Value="resumen_mes"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
