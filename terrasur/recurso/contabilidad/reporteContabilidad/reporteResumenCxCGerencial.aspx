<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Resumen de cuentas por cobrar (Gerencial)" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContabilidad", "reporteResumenCxCGerencial") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_resumen_cxc_gerencial()
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Resumen de cuentas por cobrar (Gerencial)</td>
    </tr>
    <tr>
