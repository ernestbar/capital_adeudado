<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Plan de pagos vigente en detalle" %>
...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not Page.IsPostBack Then
            If permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContrato", "reporteContratoPlanPagoVigenteDetalle") Then
                Page.Visible = True
                If Session("id_contrato") IsNot Nothing Then
    ...
    Sub CargarReportes(ByVal Contrato_id As Integer)
        ...
        Dim regEm As New terrasur.emDoc.emision("pp_vigente_detalle", Contrato_id, Profile.id_usuario, 0, "", "")
        regEm.Registrar()
        
        Dim c As New contrato(Contrato_id)
        panel_cambio.GroupingText = "Plan de pagos vigente en detalle"
        Dim ppr As New rpt_contratoPlanPagoVigenteDetalle()
        ppr.DatosPlanPagosVigenteDetalle(Contrato_id, Profile.nombre_persona)
...
<table class="priTable">
        <tr><td class="priTdTitle">Plan de pagos vigente en detalle</td></tr>
        <tr>
