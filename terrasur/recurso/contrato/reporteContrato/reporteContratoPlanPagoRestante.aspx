<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Plan de pagos restante" %>
...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not Page.IsPostBack Then
            If permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteContrato", "reporteContratoPlanPagoRestante") Then
                Page.Visible = True
                If Session("id_contrato") IsNot Nothing Then
    ...
    Sub CargarReportes(ByVal Contrato_id As Integer)
        ...
        Dim regEm As New terrasur.emDoc.emision("pp_restante", Contrato_id, Profile.id_usuario, 0, "", "")
        regEm.Registrar()

        Dim c As New contrato(Contrato_id)
        panel_cambio.GroupingText = "Plan de pagos restante"
        Dim ppr As New rpt_contratoPlanPagoRestante()
        ppr.DatosPlanPagosRestante(Contrato_id, Profile.nombre_persona)
        ...
        If c.id_planpago_vigente > 0 Then
            ...
            ppr.DataSource = contratoReporte.ReportePlanPagosRestante(c.id_contrato, c.preferencial, c.id_ultimo_pago, pp.cuota_base, pp.num_cuotas - c.cuotas_pagadas, pp.fecha_inicio_plan, pp.interes_corriente, pp.seguro, pp.mantenimiento_sus)
        Else
...
<table class="priTable">
        <tr><td class="priTdTitle">Plan de pagos restante</td></tr>
        <tr>
