<%@ Control Language="VB" ClassName="contratoDatos" %>
...
<script runat="server">
    ...
    Private Sub CargarDatos()
        ...
        Dim tabla_terraplus As Data.DataTable = terrasur.terraplus.tp_contrato.ListaContratosTerraplusPorContratoLote_lista(id_contrato)
        If tabla_terraplus.Rows.Count > 0 Then
            lbl_terraplus_vacio.Visible = False
            dl_terraplus.Visible = True
            dl_terraplus.DataSource = tabla_terraplus
            dl_terraplus.DataBind()
        Else
            lbl_terraplus_vacio.Visible = True
            dl_terraplus.Visible = False
        End If
                    ...
                    <tr>
                        <td class="contratoDatosTdGrupo">
                            <table>
                                ...
                                <tr>
                                    <td class="contratoDatosTdEnun">TerraPlus:</td>
                                    <td class="contratoDatosTdDato">
                                        <asp:Label ID="lbl_terraplus_vacio" runat="server" Text="---"></asp:Label>
                                        <asp:DataList ID="dl_terraplus" runat="server" RepeatColumns="1" CellPadding="0" CellSpacing="0">
                                            <ItemTemplate><asp:Label ID="lbl_terraplus_dato" runat="server" Text='<%# Eval("texto") %>' ToolTip='<%# Eval("mensaje") %>' ForeColor="Blue"></asp:Label></ItemTemplate>
                                        </asp:DataList>
                                    </td>
                                </tr>
                            </table>
