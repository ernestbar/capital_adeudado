    ...
    <tr>
        <td>
            <asp:Panel ID="panel_reprogramacion" runat="server">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr><td class="wpContenidoTdTitle"><asp:Label ID="lbl_reprogramacion" runat="server" SkinID="lblWebPartTitle" Text="Reprogramación"></asp:Label></td></tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="wpContenidoTdButton">
                            ...
                            <asp:Button ID="btn_reversion_deshacer" runat="server" Text="Deshacer reversión" SkinID="btnWebPart"/>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
