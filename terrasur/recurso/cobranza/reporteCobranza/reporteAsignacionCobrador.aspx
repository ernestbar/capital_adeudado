<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de contratos asignados por cobrador" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteCobranza", "reporteAsignacionCobrador") Then
    ...
    Public Sub cargarReporte()
        Dim reporte As New rpt_asignacionCobrador()
        reporte.Encabezado(Int32.Parse(ddl_cobrador.SelectedValue))
        reporte.DataSource = cobranzaReporte.ReporteAsignacionCobrador(Int32.Parse(ddl_cobrador.SelectedValue))
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte de contratos asignados por cobrador</td>
    </tr>
    <tr>
