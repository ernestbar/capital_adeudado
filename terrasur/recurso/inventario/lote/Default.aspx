...
<script runat="server">
    ...
    Protected Sub gv_lote_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_lote.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            'If Integer.Parse(DataBinder.Eval(e.Row.DataItem, "num_contratos").ToString) = 0 Then
            '    If inmueble.VerificarLoteConInmueble(Integer.Parse(DataBinder.Eval(e.Row.DataItem, "id_lote").ToString())) = True Then
