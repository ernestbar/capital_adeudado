<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Pago Según Plan" %>
...
<script runat="server">
    ...
    Protected Sub CargarTablaCuotasSegunPlan()
        ...
        For i As Integer = 1 To tabla.Rows.Count - 1
            tabla.Rows(i)("tipo_pago") = "Cuota a pagar " & i.ToString & ":"
        Next
        ...
        lbl_total_pagar.Text = monto_cuotas.ToString("F2")
    End Sub
    Protected Sub btn_pagar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_pagar.Click
        If num_cuotas <> Integer.Parse(txt_num_cuotas.Text) Then
            CargarTablaCuotasSegunPlan()
        End If
        Dim permiso_efectivo As Boolean = permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "pagoSegunPlan", "efectivo")
    ...
    Protected Sub CajaRealizarPago_Aceptar(ByVal sender As Object, ByVal e As System.EventArgs)
        If Session("permitir_pagar") = "si" Then
            Dim id_transaccion As String = pago.Insertar_PagoAdelantadoSegunPlan_VARIOS_PAGOS(Profile.id_usuario, Profile.entorno.id_rol, ContratoDatos1.id_contrato, CajaRealizarPago1.dato_id_recibo_cobrador, "pagoSegunPlan", num_cuotas, CajaRealizarPago1.dato_FormaPagoCliente, CajaRealizarPago1.dato_cliente_nombre, CajaRealizarPago1.dato_cliente_nit, CajaRealizarPago1.dato_cliente_guardar)
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_r" Runat="Server">
    <uc1:cajaMaster ID="CajaMaster1" runat="server" tipo_pago="pagoSegunPlan" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_c" Runat="Server">
    ...
    <table class="priTable">
        <tr><td class="priTdTitle">Pago Según Plan</td></tr>
        <tr>
                                    ...
                                    <td>
                                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                            <asp:View ID="View1" runat="server">
                                                <asp:Panel ID="panel_pago" runat="server" GroupingText="Pago Según Plan" DefaultButton="btn_aplicar">
                                                                ...
                                                                <table align="center" width="100%">
                                                                    <tr>
                                                                        <td>
                                                                            <table align="left">
                                                                                <tr>
                                                                                    <td class="cajaPagoTdEnun">Nº de cuotas a pagar:</td>
                                                                                    ...
                                                                                    <td><asp:Button ID="btn_aplicar" runat="server" Text="Aplicar cuotas a pagar" CausesValidation="true" ValidationGroup="adelanto_cuotas" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
