<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de ingresos en detalle" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteCaja", "reporteIngresosDetalle") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_ingresosDetalle()
        ...
        reporte.DataSource = cajaReporte.ReporteIngresos(Integer.Parse(ddl_sucursal.SelectedValue), Int32.Parse(rbl_forma_pago.SelectedValue), Int32.Parse(ddl_cajero.SelectedValue), cp_desde.SelectedDate, cp_hasta.SelectedDate, general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
        'reporte.DataSource = cajaReporte.ReporteIngresos2(Integer.Parse(ddl_sucursal.SelectedValue), Int32.Parse(rbl_forma_pago.SelectedValue), Int32.Parse(ddl_cajero.SelectedValue), cp_desde.SelectedDate, cp_hasta.SelectedDate, general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte de ingresos en detalle</td>
    </tr>
    <tr>
