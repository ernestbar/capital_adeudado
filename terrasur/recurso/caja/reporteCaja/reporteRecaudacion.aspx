<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de Recaudación" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteCaja", "reporteRecaudacion") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_ingresosRecaudacion
        reporte.Encabezado(ddl_sucursal.SelectedItem.Text, cp_desde.SelectedDate, cp_hasta.SelectedDate, Int32.Parse(rbl_forma_pago.SelectedValue), general.StringNegocios(False, cbl_negocio.Items), rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
        reporte.DataSource = recibo_gastos.ReporteRecaudacion(Integer.Parse(ddl_sucursal.SelectedValue), cp_desde.SelectedDate, cp_hasta.SelectedDate, Int32.Parse(rbl_forma_pago.SelectedValue), general.StringNegocios(True, cbl_negocio.Items), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
    ...
    Protected Sub ddl_sucursal_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddl_sucursal.DataBound
        ddl_sucursal.Items.Insert(0, New ListItem("Todos (con Sub-Totales)", "-1"))
        ...
        Dim id_sucursal_central As Integer = sucursal.IdSucursalPorNum(0)
        
        If id_sucursal_predeterminada <> id_sucursal_central And ddl_sucursal.Items.FindByValue(id_sucursal_predeterminada) IsNot Nothing Then
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte de Recaudación</td>
    </tr>
    <tr>
