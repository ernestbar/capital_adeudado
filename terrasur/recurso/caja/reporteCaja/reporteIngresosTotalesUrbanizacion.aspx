<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de ingresos - Totales por sector" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteCaja", "reporteIngresosTotalesUrbanizacion") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_ingresosTotalesUrbanizacion()
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte de ingresos - Totales por sector</td>
    </tr>
    <tr>
