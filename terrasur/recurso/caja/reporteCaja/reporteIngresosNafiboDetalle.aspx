<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de ingresos NAFIBO en detalle" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If Not permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteCaja", "reporteIngresosNafiboDetalle") Then
    ...
    Public Sub cargarReporte()
        ...
        Dim reporte As New rpt_ingresosNafiboDetalle()
        reporte.Encabezado(ddl_sucursal.SelectedItem.Text, cp_desde.SelectedDate, cp_hasta.SelectedDate, Int32.Parse(ddl_cajero.SelectedValue), rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
        reporte.DataSource = cajaReporte.ReporteNafiboIngreso(Integer.Parse(ddl_sucursal.SelectedValue), 0, Int32.Parse(ddl_cajero.SelectedValue), cp_desde.SelectedDate, cp_hasta.SelectedDate, Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
...
<table class="priTable">
    <tr>
        <td class="priTdTitle">Reporte de ingresos NAFIBO en detalle</td>
    </tr>
    <tr>
