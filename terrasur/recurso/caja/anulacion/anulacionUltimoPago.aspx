<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Anulación de un pago" %>
...
<script runat="server">
    ...
    Protected Sub CargarDatos()
        Dim up As New pago(contrato.UltimoPago(Integer.Parse(lbl_id_contrato.Text), Date.Now))
        btn_accion.Enabled = True
        lbl_pago_no.Text = (up.anterior_num_pagos + 1).ToString()
        Dim id_recibo As Integer = recibo.IdPorTransaccion(up.id_transaccion)
        Dim r As New recibo(id_recibo, 0)
        lbl_recibo.Text = r.num_recibo.ToString()
        lbl_tipo_pago.Text = New tipo_pago(up.id_tipopago).nombre
        lbl_factura.Text = New factura(factura.IdPorTransaccion(up.id_transaccion)).num_factura.ToString()
        lbl_fecha_pago.Text = up.fecha.ToString("d")
        lbl_monto.Text = up.monto_pago.ToString("F2")
    ...
    Protected Sub btn_accion_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_accion.Click
        ...
        Try
            Dim IdUltimoPago As Integer = contrato.UltimoPago(Integer.Parse(lbl_id_contrato.Text), Date.Now)
            Dim objPago As pago = New pago(IdUltimoPago)
            ...
            If pago.AnularUltimoPago(IdUltimoPago, Integer.Parse(lbl_id_contrato.Text), Profile.id_usuario, Profile.entorno.id_rol) = True Then
                If IdFactura > 0 And Cuf <> "" Then
                ...
                End If
            Else
                Msg1.Text = "LA ANULACION DEL PAGO NO SE REALIZÓ CORRECTAMENTE"
            End If
...
<asp:ScriptManager ID="ScriptManager1" runat="server"><Scripts><asp:ScriptReference Path="../../../js/scriptjs.js" /></Scripts></asp:ScriptManager>
    ...
    <table class="priTable">
        <tr><td class="priTdTitle">Anulación de un pago</td></tr>
        <tr>
                                    ...
                                    <td>
                                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                            <asp:View ID="View1" runat="server">
                                                <asp:Panel ID="panel_anulacion" runat="server" GroupingText="Último pago">
                                                    <table class="cajaPagoTable">
                                                        <tr>
                                                            <td class="cajaPagoTdContenido">
                                                                <table cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td class="contratoViewTdHorEnun">Pago No.:</td>
                                                                        <td class="contratoViewTdDato"><asp:Label ID="lbl_pago_no" runat="server"></asp:Label></td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="contratoViewTdHorEnun">Tipo de pago:</td>
                                                                        <td class="contratoViewTdDato"><asp:Label ID="lbl_tipo_pago" runat="server"></asp:Label></td>
                                                                        <td class="contratoViewTdHorEnun" width="10px"></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="contratoViewTdDato"></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="cajaPagoTdButton" colspan="2">
                                                                <asp:Button ID="btn_accion" runat="server" Text="Anular Pago"  
                                                                    CausesValidation="False" OnClientClick="return confirm('¿Esta seguro que desea anular el pago?');" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
