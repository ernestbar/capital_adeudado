<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Venta de lotes Gerencial" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteMarketing", "reporteGerencialVentas") Then
                Dim nombre_reporte As String = New permiso("reporteGerencialVentas", "reporteMarketing").nombre
    ...
    Protected Sub btn_mostrar_reporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_mostrar_reporte.Click
        ...
        Dim reporte As New rpt_ventas_gerencial
        reporte.CargarDatos(CicloComercialPeriodo1.inicio, CicloComercialPeriodo1.fin, rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
        reporte.DataSource = marketingReporte.ReporteGerencialVentas(CicloComercialPeriodo1.inicio, CicloComercialPeriodo1.fin, Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_r" Runat="Server">
    <uc1:recursoMaster ID="RecursoMaster1" runat="server" recurso="reporteMarketing" reporte="reporteGerencialVentas" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_c" Runat="Server">
    ...
    <table class="priTable">
        ...
        <tr>
            <td>
                <uc2:reporte ID="Reporte1" runat="server" NombreReporte="ReporteGerencialVentas" />
            </td>
        </tr>
    </table>
</asp:Content>
