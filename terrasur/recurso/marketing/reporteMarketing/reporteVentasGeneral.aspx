<%@ Page Language="VB" MasterPageFile="~/modulo/normal.master" Title="Reporte de ventas general" %>
...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not Page.IsPostBack Then
            If permiso.Verificar(Profile.id_usuario, Profile.entorno.id_rol, "reporteMarketing", "reporteVentasGeneral") Then
                Dim nombre_reporte As String = New permiso("reporteVentasGeneral", "reporteMarketing").nombre
                'Page.Title = nombre_reporte
                lbl_titulo.Text = nombre_reporte
                If Profile.entorno.codigo_modulo = "adm" Or Profile.id_usuario = 307 Then
                    lbl_mostrar_saldos.Visible = True
                    cb_mostrar_saldos.Visible = True
                Else
                    lbl_mostrar_saldos.Visible = False
                    cb_mostrar_saldos.Visible = False
                End If
                cb_mostrar_saldos.Checked = False
            Else
    ...
    Protected Sub btn_mostrar_reporte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_mostrar_reporte.Click
        ...
        If cb_mostrar_saldos.Checked = False Then
            Dim reporte As New rpt_ventas_general
            reporte.CargarDatos(CicloComercialPeriodo1.inicio, CicloComercialPeriodo1.fin, ddl_grupoventa.SelectedItem.Text, ddl_promotor.SelectedItem.Text, ddl_localizacion.SelectedItem.Text, ddl_urbanizacion.SelectedItem.Text, rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
            reporte.DataSource = marketingReporte.ReporteVentasGeneral(CicloComercialPeriodo1.inicio, CicloComercialPeriodo1.fin, Integer.Parse(ddl_grupoventa.SelectedValue), Integer.Parse(ddl_promotor.SelectedValue), Integer.Parse(ddl_localizacion.SelectedValue), Integer.Parse(ddl_urbanizacion.SelectedValue), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
            Reporte1.WebView.Report = reporte
        Else
            Dim reporte As New rpt_ventas_general2
            reporte.CargarDatos(CicloComercialPeriodo1.inicio, CicloComercialPeriodo1.fin, ddl_grupoventa.SelectedItem.Text, ddl_promotor.SelectedItem.Text, ddl_localizacion.SelectedItem.Text, ddl_urbanizacion.SelectedItem.Text, rbl_moneda.SelectedItem.Text.ToUpper, rbl_consolidado.SelectedItem.Text.ToUpper, Codigo_moneda)
            reporte.DataSource = marketingReporte.ReporteVentasGeneral2(CicloComercialPeriodo1.inicio, CicloComercialPeriodo1.fin, Integer.Parse(ddl_grupoventa.SelectedValue), Integer.Parse(ddl_promotor.SelectedValue), Integer.Parse(ddl_localizacion.SelectedValue), Integer.Parse(ddl_urbanizacion.SelectedValue), Integer.Parse(rbl_moneda.SelectedValue), rbl_consolidado.SelectedValue.Equals("True"))
            Reporte1.WebView.Report = reporte
        End If
    End Sub
                        ...
                        <tr>
                            <td class="formEntTdForm">
                                <table class="formTable" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="formTdEnun"><asp:Label ID="lbl_mostrar_saldos" runat="server" Text="Mostrar saldos:"></asp:Label></td>
                                        <td class="formTdDato"><asp:CheckBox ID="cb_mostrar_saldos" runat="server" Text="Mostrar saldos y capital amortizado" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
